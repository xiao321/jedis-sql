...
public class Jedis extends BinaryJedis implements JedisCommands, MultiKeyCommands,
    AdvancedJedisCommands, ScriptingCommands, BasicCommands, ClusterCommands, SentinelCommands, ModuleCommands, SQLCommond {
  ...
  @Override
  public List<Object> executeSQL(String database, String sql) {
    checkIsInMultiOrPipeline();
